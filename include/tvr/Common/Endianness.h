...
#include <tvr/Common/IntegerByteSwap.h>
...
#define TVR_IS_LITTLE_ENDIAN
#define TVR_BYTE_ORDER_ABCD
#elif BOOST_ENDIAN_BIG_BYTE
#define TVR_IS_BIG_ENDIAN
#define TVR_BYTE_ORDER_DCBA
#else
...
#if defined(TVR_IS_BIG_ENDIAN)
        template <typename T>
        struct NetworkByteOrderTraits<
            T, typename std::enable_if<std::is_integral<T>::value>::type>
            : detail::NoOpHostNetworkConversion<T> {};

#elif defined(TVR_IS_LITTLE_ENDIAN)
        template <typename T>
        struct NetworkByteOrderTraits<
            T, typename std::enable_if<std::is_integral<T>::value>::type>
...
#if defined(TVR_FLOAT_ORDER_MIXED)
