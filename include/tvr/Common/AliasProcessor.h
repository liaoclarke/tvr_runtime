...
#ifndef INC_Common_AliasProcessor_h
#define INC_Common_AliasProcessor_h
...
namespace common {
    ...
    TVR_COMMON_EXPORT Json::Value convertRouteToAlias(Json::Value const &val);
    ...
    class AliasProcessor {
      public:
        ...
        TVR_COMMON_EXPORT bool process(PathNode &node, Json::Value const &val);
        /// @}
      private:
