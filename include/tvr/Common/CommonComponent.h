...
// Internal Includes
#include <tvr/Common/CommonComponent_fwd.h>
#include <tvr/Common/Export.h>
#include <tvr/Common/DeviceComponent.h>
#include <tvr/TypePack/List.h>
#include <tvr/TypePack/TypeKeyedMap.h>
...
namespace common {
    namespace messages {
        class VRPNPing : public MessageRegistration<VRPNPing> {
          public:
            TVR_COMMON_EXPORT static const char *identifier();
        };
    ...
    class CommonComponent : public DeviceComponent {
      public:
        ...
        /// side of a DLL line.
        static TVR_COMMON_EXPORT shared_ptr<CommonComponent> create();
        ...
        TVR_COMMON_EXPORT void registerPingHandler(Handler const &handler);
        ...
        TVR_COMMON_EXPORT void registerPongHandler(Handler const &handler);
      ...
      private:
        ...
        TVR_COMMON_EXPORT void
        m_registerHandlerImpl(HandlerList &handlers,
                              tvr::common::RawMessageType rawMessageType,
                              Handler const &handler);
